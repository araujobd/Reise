...
public class MainActivity extends AppCompatActivity implements LoginContrato.Presenter{
    private SignInButton GoogleBtn;
    public static final String PARCEL_KEY = "parcel_key";
    LoginButton login_button; //botao facebook
    ...
    private void configurarVariaveis() {
        ...
        login_button = (LoginButton)findViewById(R.id.login_button); //botao do facebook
